...
export default class CenaMoedas extends Cena {
  ...
  preparar() {
    ...
    this.adicionar(en1);
    this.adicionar(
      new Sprite({ x: 115, y: 70, color: "yellow", tags: ["moeda"] })
    );
    this.adicionar(
      new Sprite({ x: 650, y: 70, color: "yellow", tags: ["moeda"] })
    );
    this.adicionar(
      new Sprite({ x: 150, y: 180, color: "yellow", tags: ["moeda"] })
    );
    this.adicionar(
      new Sprite({ x: 315, y: 299, color: "yellow", tags: ["moeda"] })
    );
